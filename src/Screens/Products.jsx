    ...
    return (
        ...
        {/* onHide={setShow(false)} */}
           ...
           <Container >
            ...
            <button onClick={() => history.push('/new')} className='button' style={{display:'flex', alignItems:'center', borderRadius:10}}>
                <FontAwesomeIcon size="2x" style={{marginRight:10}} icon={faPlusCircle}/>
