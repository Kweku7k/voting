...
const Products = () => {
  ...
  const access_token =
    "IGQVJYN0VaQ0QySFJTaUROdFV0c0hIODhzYnZAwTExOQzZA5cDVIQ1NZAUGFMM0dtWHI4X1VORy11REl4MTlRWU5vU3pkOGI0Yzk5b1dneWJ1ZAm1LTUFOcVNEQ1BGWmxYX2NUOWp2S2lma29hTjlobURxdgZDZD";
  ...
  const check = (post) => {
    window.location.href =
      "https://gsu.qhx.mybluehost.me/?product=38?per_page=200";
    // findPost(post.id)
    console.log(post);
  ...
  const [spreadsheet, setspreadsheet] = useState([
    {
      ...
      wooId:
        "https://gsu.qhx.mybluehost.me/?product=example-of-a-simple-product",
    },
    {
      igId: "17934647698581558",
      wooId:
                ...
                (post) =>
                  post.status == "publish" && (
                    <Item
                      ...
                      wooUrl={post.permalink}
                      key={post.id}
                      media={post.images[0] ? post.images[0].src : null}
